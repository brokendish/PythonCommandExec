...
#　改定
#　2016/02/28
#　　・選択範囲で改行があった場合に改行を削除（複数行のパイプを実行可能にする）
#　　・コマンドエリアの背景色、フォント色を変更
#　　・履歴削除ボタンの背景色を変更
#
#
#-------------------------------------------------------------------------------
...
#ラベル（コメント）
msg="下記のコマンドエリアに入力し、選択した部分を実行します。実行は「F1」、「右クリック」、「実行ボタン」"
...
#テキストエリア（入力用）
inTex = St.ScrolledText(root, font=('Times', '12'),height=10,bg='#555555',fg='white')	#背景色[bg]、フォントの色[fg]を指定
...
#ボタン5
btn5 = Tk.Button(root, text="履歴削除", font=('Times', '12'),anchor=Tk.CENTER,command=hisdel,bg='pink')
